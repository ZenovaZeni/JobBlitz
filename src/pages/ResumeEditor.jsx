...
export default function ResumeEditor() {
  ...
  const isDedicatedPreview = new URLSearchParams(location.search).get('preview') === 'true'
  ...
  return (
    <div className={`flex h-screen overflow-hidden ${isDedicatedPreview ? 'justify-center bg-[#f2f4f6]' : ''}`} style={{ backgroundColor: '#f2f4f6' }}>
        ...
        <div
          ...
          {resume ? (
            <div style={{
              ...
              marginBottom: isMobileCanvas && !isDedicatedPreview
